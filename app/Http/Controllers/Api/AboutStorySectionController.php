...
class AboutStorySectionController extends Controller
{
    ...
    public function upsert(Request $request)
    {
        $validated = $request->validate([
            ...
            'experience_value_en'  => 'nullable|string|max:80',
            'experience_value_ko'  => 'nullable|string|max:80',
            'experience_value_zh'  => 'nullable|string|max:80',
            ...
            'travelers_value_en'   => 'nullable|string|max:80',
            'travelers_value_ko'   => 'nullable|string|max:80',
            'travelers_value_zh'   => 'nullable|string|max:80',
